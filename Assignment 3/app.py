...
with st.sidebar:
    ...
    context_size = st.slider("context size", 10, max_context_size, 1)
...
with st.spinner("Loading model..."):
    ...
    if model_choice == "Model - Epoch 50":
        model_path = "model_epoch50.pth"
    elif model_choice == "Model - Epoch 50 with dropout":
        model_path = "model_epoch50_dropout.pth"
    elif model_choice == "Model - Epoch 25 Linux":
        model_path = "model_epoch25_2.pth"
    elif model_choice == "Model - Epoch 50 Linux":
        model_path = "model_epoch50_2.pth"
